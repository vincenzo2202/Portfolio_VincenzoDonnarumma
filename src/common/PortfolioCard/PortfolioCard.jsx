...
export const PortfolioCard = ({cardImage, cardName, cardInfo, cardPreview, cardCode })=>{

    return(
        <>
        <div class="card">
  <div class="card__img"><img class="card__img" src={cardImage} alt={cardImage} /></div>
  ...
  <div class="card__links">
    <div>
    <a class="link" href={cardPreview} target='_blank' rel='noopener noreferrer'>
      ...
      <a class="link" href={cardPreview} target='_blank' rel='noopener noreferrer'>Preview</a>
      </a>
    </div>
    <div>
    <a class="link" href={cardCode} target='_blank' rel='noopener noreferrer' >
      ...
      <a class="link" href={cardCode} target='_blank' rel='noopener noreferrer' >Code</a>
      </a>
    </div>
  </div>
  </div>
